...
public class DefectLogger {
	...
	private void createAllDefects(XSSFSheet sheet){
		...
		for(int keyIndex = 0; keyIndex < totalNumOfEntries; keyIndex++){
			...
			String moduleData=getFormattedString(moduleTemplate, scenarioAndTestCase);	
			...
			createDefect(sheet.createRow(rowCount++),moduleData,summaryData,descHeaderData,descStepData, sheet);
		}		
	}
	 ...
	 */
	private void createDefect(Row row, String moduleData,String summaryData,String descHeaderData,String descStepData,XSSFSheet sheet){
		logger.info("Creating a defect");
		String[] data = getDefectData(summaryData,descHeaderData,descStepData,moduleData);
		int columnCount = 0;		
	 ...
	 */
	private String[] getDefectData(String summaryData,String descHeaderData,String descStepData,String moduleData){
...
//		System.out.println(path);
	...
	private void loadTemplates(ResourceBundle bundle){
		moduleTemplate=bundle.getString("data.module");
